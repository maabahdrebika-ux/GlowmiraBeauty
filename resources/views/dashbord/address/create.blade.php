@extends('layouts.app')
@section('title', trans('address.add'))
@section('content')
    ...
    <div class="col-sm-12">
        <div class="page-title-box">
         ...
         <h4 class="mt-0 header-title"><a
                                href="{{ route('addresses') }}">{{ trans('app.address') }}</a>/{{ trans('address.add') }}</h4>                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="" action="">
                            ...
                            <div class="form-group">
                                <button type="submit"
                                    class="btn btn-primary waves-effect waves-light">{{ trans('address.addbtn') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
