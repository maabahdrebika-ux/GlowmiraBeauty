    ...
    <div class="col-sm-12">
        <div class="page-title-box">
         ...
         <h4 class="mt-0 header-title"><a
                                href="{{ route('blogs.index') }}">{{ trans('blog.title') }}</a>/{{ trans('blog.add') }}</h4>                </div>
            ...
            <div class="col-lg-12 card">
                <div class=" m-b-30">
                    <div class="card-body">
                        ...
                        <form method="POST" class="" action="{{ route('blogs.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="description_ar"
                                        ...
                                        id="description_ar"
                                        placeholder="{{ trans('blog.description_ar') }}" rows="4" required>{{ old('description_ar') }}</textarea>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="description_en"
                                        ...
                                        id="description_en"
                                        placeholder="{{ trans('blog.description_en') }}" rows="4" required>{{ old('description_en') }}</textarea>
                            ...
                            <div class="form-group">
                                <button type="submit"
                                    class="btn btn-primary waves-effect waves-light">{{ trans('blog.addbtn') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
