                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="mt-0 header-title"><a
                                    href="{{ route('products') }}">{{ __('product.products_link') }}</a>/{{ __('product.edit_product') }}
                            </h4>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="namee"
                                        class="control-label">{{ __('product.product_name_english') }}</label>
                                    <input type="text" name="namee"
                                        class="form-control @error('namee') is-invalid @enderror"
                                        value="{{ old('namee', $product->namee) }}" id="namee"
                                        placeholder="{{ __('product.product_name_english') }}">
                                    @error('namee')
                                        <span class="invalid-feedback" role="alert"
                                            style="color: red">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="barcode"
                                        ...
                                        value="{{ old('barcode', $product->barcode) }}" id="barcode"
                                ...
                                <div class="form-group col-md-3">
                                    <label for="brandname_ar"
                                        class="control-label">{{ __('product.brandname_ar') }}</label>
                                    <input type="text" name="brandname_ar"
                                        class="form-control @error('brandname_ar') is-invalid @enderror"
                                        value="{{ old('brandname_ar', $product->brandname_ar) }}" id="brandname_ar"
                                        placeholder="{{ __('product.brandname_ar') }}">
                                    @error('brandname_ar')
                                        <span class="invalid-feedback" role="alert"
                                            style="color: red">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-md-3">
                                    <label for="brandname_en"
                                        class="control-label">{{ __('product.brandname_en') }}</label>
                                    <input type="text" name="brandname_en"
                                        class="form-control @error('brandname_en') is-invalid @enderror"
                                        value="{{ old('brandname_en', $product->brandname_en) }}" id="brandname_en"
                                        placeholder="{{ __('product.brandname_en') }}">
                                    @error('brandname_en')
                                        <span class="invalid-feedback" role="alert"
                                            style="color: red">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="country_of_origin_ar"
                                        class="control-label">{{ __('product.country_of_origin_ar') }}</label>
                                    <input type="text" name="country_of_origin_ar"
                                        class="form-control @error('country_of_origin_ar') is-invalid @enderror"
                                        value="{{ old('country_of_origin_ar', $product->country_of_origin_ar) }}"
                                        id="country_of_origin_ar" placeholder="{{ __('product.country_of_origin_ar') }}">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="country_of_origin_en"
                                        class="control-label">{{ __('product.country_of_origin_en') }}</label>
                                    <input type="text" name="country_of_origin_en"
                                        class="form-control @error('country_of_origin_en') is-invalid @enderror"
                                        value="{{ old('country_of_origin_en', $product->country_of_origin_en) }}"
                                        id="country_of_origin_en" placeholder="{{ __('product.country_of_origin_en') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="description_ar"
                                        class="control-label">{{ __('product.product_description_arabic') }}</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="description_en"
                                        class="control-label">{{ __('product.product_description_english') }}</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    @if ($product->image)
                                        <div class="mt-2">
                                            ...
                                            <img src="{{ asset('images/product/' . $product->image) }}"
                                                alt="Product Image" id="imagePreview" class="img-thumbnail"
                                                width="150">
                                        </div>
                                    @else
                                        <div class="mt-2">
                                    ...
                                    @endif
                                    <label for="image"
                                        class="control-label">{{ __('product.cover_image_label') }}</label>
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="input-group">
                                                            <input type="text" name="size[]"
                                                                ...
                                                                placeholder="{{ __('product.enter_sizes') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                                        <button type="button"
                                                        ...
                                                        @if ($loop->last)
                                                            <button type="button"
                                                                class="btn btn-success add-size">{{ __('product.add') }}</button>
                                                        @endif
                                                    </div>
                                                </div>
                                            @endforeach
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group">
                                                        <input type="text" name="size[]" class="form-control"
                                                            placeholder="{{ __('product.enter_size') }}">
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                    ...
                                    <div id="coolor-container">
                                        @if ($product->coolors->count() > 0)
                                            @foreach ($product->coolors as $coolor)
                                                <div class="row mb-2">
                                                    <div class="col-md-10">
                                                        <div class="input-group">
                                                            <input type="text" name="coolor[]"
                                                                value="{{ $coolor->name }}" class="form-control"
                                                    ...
                                                    <div class="col-2">
                                                        <button type="button"
                                                            class="btn btn-danger remove-coolor">-</button>
                                                        @if ($loop->last)
                                                            <button type="button"
                                                                class="btn btn-success add-coolor">{{ __('product.add_color') }}</button>
                                                        @endif
                                                    </div>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="row mb-2">
                                                <div class="col-md-10">
                                                    <div class="input-group">
                                                        <input type="color" name="coolor[]" class="form-control"
                                                            value="#000000"
                                                            onchange="this.nextElementSibling.innerText = this.value;">
                                                        <div class="input-group-append">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="gallery" id="gallery-container">
                                        @foreach ($image as $img)
                                            <div class="image-item" style="display: inline-block; position: relative; margin:5px;" data-image-id="{{ $img->id }}">
                                                <img src="{{ asset('images/product/' . $img->name) }}"
                                                    alt="Gallery Image" class="img-thumbnail" width="100">
                                                <a href="javascript:void(0)"
                                                    style="position: absolute; top: 0; right: 0;"
                                                    class="delete-image-btn"
   data-url="{{ route('products.image.delete', $img->id) }}">
                                                       <i class="fa fa-times"
                                                        style="color:red; background:#fff; border-radius:50%; padding:2px;"></i>
                                                </a>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <label for="image"
                                        class="control-label">{{ __('product.additional_images') }}</label>
...
<script>
function deleteImageConfirmation(url, imageId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        icon: 'success',
                        title: '{{ __("product.image_deleted_successfully") }}',
                        timer: 1200,
            ...
            .catch(() => {
                Swal.fire(
                    'Error',
                    '{{ __("product.error_deleting_image") }}',
                    'error'
                );
            });
        }
...
document.addEventListener('click', function (e) {
    ...
    if (btn) {
        ...
        deleteImageConfirmation(
            btn.dataset.url,
            btn.closest('.image-item').dataset.imageId
        );
    }
});
</script>
    ...
    {{-- <script>
        function deleteImageConfirmation(url) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // Make the delete request using AJAX
                    fetch(url, {
                        method: 'GET',
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            const deleteBtn = document.querySelector(`[data-url="${url}"]`);
                            if (deleteBtn) {
                                deleteBtn.closest('.image-item').remove();
                            }
                        } else {
                            Swal.fire({
                                icon: 'error',
                                title: data.message || '{{ __('product.error_deleting_image') }}',
                    ...
                    .catch(error => {
                        Swal.fire({
                            icon: 'error',
                            title: '{{ __('product.error_deleting_image') }}',
                            text: error.message,
                            showConfirmButton: true
                        });
                    });
        ...
        // Event delegation for delete image buttons
        document.addEventListener('DOMContentLoaded', function() {
            // Handle delete image button clicks using event delegation
            document.addEventListener('click', function(e) {
                const deleteBtn = e.target.closest('.delete-image-btn');
                if (deleteBtn) {
                    e.preventDefault();
                    const url = deleteBtn.getAttribute('data-url');
                    deleteImageConfirmation(url);
                }
            });
            ...
            // Display warning message if exists in session
            @if(session('warning'))
                Swal.fire({
                    position: 'top-end',
                    icon: 'warning',
