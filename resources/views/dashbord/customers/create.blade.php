...
@section('title', trans('customers.add_customer'))
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title">{{ trans('customers.add_new_customer') }}</h4>
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ trans('customers.add_customer') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('customers.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password">{{ trans('customers.password') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password_confirmation">{{ trans('customers.confirm_password') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <div>
                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                    <i class="fa fa-save"></i> {{ trans('customers.save_customer') }}
                                </button>
