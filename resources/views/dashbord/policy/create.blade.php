        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="mt-0 header-title"><a href="{{ route('policy.index') }}">{{ trans('policy.breadcrumb') }}</a> / {{ trans('policy.create_new_policy') }}</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 card">
            <div class="card-body">
                <form method="POST" action="{{ route('policy.store') }}">
                    ...
                    <button type="submit" class="btn btn-primary">{{ trans('policy.add') }}</button>
                </form>
            </div>
        </div>
    </div>
