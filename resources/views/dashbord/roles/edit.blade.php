@extends('layouts.app')
@section('title', trans('roles.edit'))
@section('content')
    ...
    <div class="col-sm-12">
        <div class="page-title-box">
         ...
         <h4 class="mt-0 header-title"><a
                                href="{{ route('roles.index') }}">{{ trans('roles.title') }}</a>/{{ trans('roles.edit') }}</h4>                </div>
            ...
            <div class="col-lg-12 card">
                <div class=" m-b-30">
                    <div class="card-body">
                        ...
                        <form method="POST" class="" action="{{ route('roles.update', encrypt($role->id)) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            ...
                            <div class="form-group">
                                <button type="submit"
                                    class="btn btn-primary waves-effect waves-light">{{ trans('roles.editbtn') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
