@extends('layouts.app')
@section('title', trans('order.processing_orders'))
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title">{{ trans('order.processing_orders') }}</h4>
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ trans('order.processing_orders') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#datatable-buttons').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('underprocess/oreders') }}',
            type: 'GET',
