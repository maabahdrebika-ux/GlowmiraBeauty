@extends('layouts.app')
@section('title', trans('order.cancelled_orders'))
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title">{{ trans('order.cancelled_orders') }}</h4>
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ trans('order.cancelled_orders') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
