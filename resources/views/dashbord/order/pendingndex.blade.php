@extends('layouts.app')
@section('title', trans('order.pending_orders'))
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title">{{ trans('order.pending_orders') }}</h4>
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ trans('order.pending_orders') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('order.cancel_order') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
