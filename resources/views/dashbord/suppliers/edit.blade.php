    ...
    <div class="col-sm-12">
        <div class="page-title-box">
         ...
         <h4 class="mt-0 header-title"><a
                                href="{{ route('suppliers') }}">{{ trans('supplier.suppliers') }}</a>/{{ trans('supplier.edit_supplier') }}</h4>                </div>
            ...
            <div class="col-lg-12 card">
                <div class=" m-b-30">
                    <div class="card-body">
                        ...
                        <form method="POST" class="" action="{{ route('suppliers/update', encrypt($supplier->id)) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        value="{{ old('name', $supplier->name) }}" id="name"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="phone"
                                        ...
                                        value="{{ old('phone', $supplier->phone) }}" id="phone"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        value="{{ old('email', $supplier->email) }}" id="email"
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="notes" class="form-control @error('notes') is-invalid @enderror"
                                        id="notes" rows="4" placeholder="{{ trans('supplier.enter_notes') }}">{{ old('notes', $supplier->notes) }}</textarea>
                                    @error('notes')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="form-group">
                                <button type="submit"
                                    class="btn btn-primary waves-effect waves-light">{{ trans('supplier.update') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
